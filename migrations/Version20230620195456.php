 ...
 */
final class Version20230620195456 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE picture (id INT AUTO_INCREMENT NOT NULL, reference VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL, subtitle VARCHAR(255) DEFAULT NULL, technic VARCHAR(255) DEFAULT NULL, size VARCHAR(255) NOT NULL, category VARCHAR(255) DEFAULT NULL, number INT DEFAULT NULL, comment LONGTEXT DEFAULT NULL, link VARCHAR(300) DEFAULT NULL, image VARCHAR(255) NOT NULL, date DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
