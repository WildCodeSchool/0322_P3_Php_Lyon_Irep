 ...
 */
final class Version20230707085801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE page_visit (id INT AUTO_INCREMENT NOT NULL, picture_id INT DEFAULT NULL, route_name VARCHAR(255) NOT NULL, visited_at DATETIME NOT NULL, INDEX IDX_25FF16EFEE45BDBF (picture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
