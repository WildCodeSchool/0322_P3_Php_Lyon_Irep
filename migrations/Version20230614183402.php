 ...
 */
final class Version20230614183402 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE presentation_exhibition (id INT AUTO_INCREMENT NOT NULL, exhibition_id_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, subtitle VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_E22D49A826FA52B6 (exhibition_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE presentation_exhibition ADD CONSTRAINT FK_E22D49A826FA52B6 FOREIGN KEY (exhibition_id_id) REFERENCES exhibition (id)');
    }
